 ...
 * @generated
 */
public class FlexmlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FlexmlPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = caseNamedObject(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlexmlPackage.CHILD: {
				Child child = (Child)theEObject;
				T result = caseChild(child);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlexmlPackage.DEFINITION: {
